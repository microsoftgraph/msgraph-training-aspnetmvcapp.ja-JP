# <a name="microsoft-graph-training-module---build-mvc-apps-with-the-microsoft-graph-net-sdk"></a>microsoft graph トレーニングモジュール-microsoft graph .net SDK を使用した MVC アプリのビルド
...
| スポンサー/サポート    | yina (as) (Microsoft)@yinaa                                   |
